...
function get_sample_action($link,$sample_id)
{
	echo '<div class="d-inline-block" >
	<form method=post>
	<button type=submit class="btn btn-outline-dark btn-sm" name=action value=sample_prepared >Sample Prepared</button>
	<button type=submit class="btn btn-outline-dark btn-sm" name=action value=analysis_started >Analysis Started</button>
	<input type=hidden name=session_name value=\''.$_POST['session_name'].'\'>
	<input type=hidden name=sample_id value=\''.$sample_id.'\'>
	</form></div>';	
}
